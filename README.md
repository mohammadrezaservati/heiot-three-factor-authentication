...
Representative execution log generated by the HEIoT prototype. The file contains protocol outputs, intermediate cryptographic values, authentication messages, session key derivation results, and execution traces that can be used to reproduce and verify the protocol workflow.
